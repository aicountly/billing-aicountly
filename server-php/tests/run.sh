#!/usr/bin/env bash
# Run the Billing integration tests against a throwaway PostgreSQL database and a
...
DB_NAME="${TEST_DB_NAME:-billing_test}"
DB_USER="${TEST_DB_USER:-billing_test}"
DB_PASS="${TEST_DB_PASS:-billing_test}"
