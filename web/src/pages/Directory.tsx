 ...
 * here. That is why this screen searches rather than listing everything — there
 ...
 * Books, and a second place to create one is a second place for the same
 * customer to exist under two names.
 *
 * Items used to live in this file and now have a screen of their own — see
 * pages/items/ItemsPage.tsx — for the same reason under a different owner.
 */
