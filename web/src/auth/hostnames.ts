 ...
 * billing.aicountly.com and billing.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'billing').trim() || 'billing'
...
/**
 * `billing.aicountly.com` and `billing.gh.aicountly.com` both resolve to
 * `billing`, which is what the portal expects in authentication_jump.
 */
