...
export const compliance: ComplianceDashboard = {
  ...
  panels: {
    ...
    accounts: [
      ...
      { account_id: 102, account_name: 'HDFC Bank', balance: 282000, kind: 'bank' },
    ],
    can_move_money: true,
    can_take_money: true,
    can_pay: true,
  ...
  rows: [
    {
      ...
      request_id: 221, kind: 'expense', account_id: 102, account_name: 'HDFC Bank',
    ...
    },
    {
      ...
      request_id: 219, kind: 'payment', account_id: 102, account_name: 'HDFC Bank',
    ...
    },
    {
      ...
      request_id: 214, kind: 'payment', account_id: 103, account_name: 'ICICI Current',
...
export const cashBankAccounts = [
  ...
  { acc_id: 102, acc_name: 'HDFC Bank', group_name: 'Bank Accounts', account_no: '502000124471' },
  { acc_id: 103, acc_name: 'ICICI Current', group_name: 'Bank Accounts', account_no: '123456789082' },
  { acc_id: 104, acc_name: 'Petty cash', group_name: 'Cash-in-hand' },
]
...
export const recentExpenses = {
  rows: [
    ...
    },
    {
      ...
      category_id: 813, category_name: 'Electricity & Utilities', paid_from_id: 102, paid_from_name: 'HDFC Bank',
    ...
    },
    {
      ...
      category_id: 814, category_name: 'Professional Fees', paid_from_id: 102, paid_from_name: 'HDFC Bank',
