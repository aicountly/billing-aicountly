...
/* ---------------------------------------------------------------------------
   ...
   does, and two copies of a master is how the two booths end up disagreeing
...
/** What one supplier is owed, as the payables report answers for an account. */
export const supplierPayables = {
  ...
  parties: [
    { account_id: 606, account_name: 'Sharma Paper Mart', total: 16300, overdue: 0, bill_count: 2, oldest_overdue_days: 0 },
    { account_id: 601, account_name: 'Shree Stationers', total: 8200, overdue: 8200, bill_count: 1, oldest_overdue_days: 12 },
  ],
  bills: [],
  note: 'Read from Smart Books just now.',
}
